        ...
        <>
            ...
            <div className=" w-full  paramain py-6 lg:py-12">
                <div className=" flex flex-col justify-center items-center gap-4 px-4">
                    <h2 className="font-bold text-4xl text-center">We Value Your Feedback</h2>
                    <p className=" text-lg font-semibold text-center lg:px-52">We appreciate your visit and would love to hear your thoughts.  Please take a moment  to provide your valuable feedback.</p>
                </div>
                ...
                <div className="px-4 lg:px-80  md:px-40 py-8">
                    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                        <div>
                            <label htmlFor="name" className="block text-md font-medium mb-2 ml-2">Name</label>
                            <input
                        ...
                        <div>
                            <label htmlFor="feedback" className="block text-md font-medium mb-2 ml-2">Feedback</label>
                            <textarea
                        ...
                        <div className="flex justify-start">
                            <button type="submit"
                             className="px-6 py-2 bg-[#7dc8e3] border rounded-3xl font-semibold text-md
                             ">
